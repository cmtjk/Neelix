package de.cmtjk.neelix.model.resources;
...
public class RequestType {
    ...
    private final boolean osIndependency;
    ...
    public RequestType(String name, String description, String osIndependency) throws SystemException {
        if (name != null && description != null && osIndependency != null) {
            ...
            this.osIndependency = "true".equalsIgnoreCase(osIndependency);
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (name == null) {
            ...
            return false;
        return osIndependency == other.osIndependency;
    }
