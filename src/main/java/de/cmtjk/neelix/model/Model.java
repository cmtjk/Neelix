package de.cmtjk.neelix.model;

import de.cmtjk.neelix.logger.Logger;
import de.cmtjk.neelix.model.database.DatabaseConnection;
import de.cmtjk.neelix.model.database.MysqlHandler;
import de.cmtjk.neelix.model.evaluator.CsvWriter;
import de.cmtjk.neelix.model.evaluator.Evaluator;
import de.cmtjk.neelix.model.evaluator.HTMLFileWriter;
import de.cmtjk.neelix.model.filehandler.FileReader;
...
public class Model {
    ...
    public boolean deleteRequest(Request requestToDelete) throws SystemException {
        if (requestToDelete != null) {
            Logger.getInstance().trace("DELETING: Deleting " + requestToDelete);
